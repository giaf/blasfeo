...
OBJS += ./kernel/avx2/kernel_dgemm_4x4_lib4.o ./kernel/avx2/kernel_dgemm_8x4_lib4.o ./kernel/avx/kernel_dgemv_4_lib4.o
endif
ifeq ($(TARGET), X64_SANDY_BRIDGE)
OBJS += ./kernel/avx/kernel_dgemm_4x4_lib4.o ./kernel/avx/kernel_dgemm_8x4_lib4.o ./kernel/avx/kernel_dgemv_4_lib4.o 
endif
ifeq ($(TARGET), GENERIC)
