...
#define CREATE_STRMAT blasfeo_blasfeo_create_dmat_ref
#define CREATE_STRVEC blasfeo_blasfeo_create_dvec_ref

#define CVT_MAT2STRMAT blasfeo_blasfeo_pack_dmat_ref
#define CVT_TRAN_MAT2STRMAT blasfeo_blasfeo_pack_tran_dmat_ref
#define CVT_VEC2STRVEC blasfeo_blasfeo_pack_dvec_ref
#define CVT_STRMAT2MAT blasfeo_blasfeo_unpack_dmat_ref
#define CVT_TRAN_STRMAT2MAT blasfeo_blasfeo_unpack_tran_dmat_ref
#define CVT_STRVEC2VEC blasfeo_blasfeo_unpack_dvec_ref
