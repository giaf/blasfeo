...
#define CREATE_STRMAT blasfeo_blasfeo_create_smat_ref
#define CREATE_STRVEC blasfeo_blasfeo_create_svec_ref

#define CVT_MAT2STRMAT blasfeo_blasfeo_pack_smat_ref
#define CVT_TRAN_MAT2STRMAT blasfeo_blasfeo_pack_tran_smat_ref
#define CVT_VEC2STRVEC blasfeo_blasfeo_pack_svec_ref
#define CVT_STRMAT2MAT blasfeo_blasfeo_unpack_smat_ref
#define CVT_TRAN_STRMAT2MAT blasfeo_blasfeo_unpack_tran_smat_ref
#define CVT_STRVEC2VEC blasfeo_blasfeo_unpack_svec_ref
