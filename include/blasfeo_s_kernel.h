...
// auxiliary routines
void kernel_sgecp_4_0_lib4(int tri, int kmax, float alpha, float *A, float *B);
void kernel_sgecp_4_1_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_4_2_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_4_3_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_3_0_lib4(int tri, int kmax, float alpha, float *A, float *B);
void kernel_sgecp_3_2_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_3_3_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_2_0_lib4(int tri, int kmax, float alpha, float *A, float *B);
void kernel_sgecp_2_3_lib4(int tri, int kmax, float alpha, float *A0, int sda, float *B);
void kernel_sgecp_1_0_lib4(int tri, int kmax, float alpha, float *A, float *B);
